...
//----------------------------------------------------------------------------------------------------------//
	...
	protected void Read_Property_File() {
		...
		String path = "C:\\Users\\Lenovo\\eclipse-workspace\\Java-selenum-demo-main2\\src\\test\\resources\\config.properties";
		try {
			prop = new Properties();
...
//----------------------------------------------------------------------------------------------------------//
	...
	protected void Read_QA_Property() {
		...
		String path = "C:\\Users\\Lenovo\\eclipse-workspace\\Java-selenum-demo-main2\\src\\main\\resources\\environments\\QAEnvironment.properties";
		try {
